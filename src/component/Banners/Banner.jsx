...
const Banner = () => {
  return (
    <section className='bg-secondary/20'>
        <div className="container grid grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 py-14">
            {/* banner img */}
            <div className='flex justify-center items-center'>
                ...
                viewport={{once:true}}
                src={BannerImg} alt="" className='w-[300px] md:max-[400px] h-full object-cover drop-shadow' />
            </div>
